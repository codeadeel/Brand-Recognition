...
def add_brServicer_to_server(servicer, server):
    rpc_method_handlers = {
...
class br(object):
    ...
    def inference(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/br/inference',

...
"""
BRAND RECOGNITION MULTI LIVE INFERENCE CLIENT FOR RTSP
======================================================
...
class Live:
    ...
    def __str__(self):
        ...
        print("""
        ============================================================
        | Brand Recognition RTSP Based Multi Live Inference Client |
        ============================================================
        """)
        print(f'Live Links: {self.live_links}')
        print(f'Brand Recognitions Server IP Address: {self.sc_server_ip}')

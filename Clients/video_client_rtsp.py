...
"""
BRAND RECOGNITION LOCAL INFERENCE CLIENT FOR RTSP
=================================================
...
class Video:
    ...
    def __str__(self):
        ...
        print("""
        =======================================================
        | Brand Recognition RTSP Based Local Inference Client |
        =======================================================
        """)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Brand Recognition RTSP Based Local Video Inference Client.')

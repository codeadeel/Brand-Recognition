...
"""
BRAND RECOGNITION LOCAL INFERENCE CLIENT IN WEB BROWSER
=======================================================
...
class Video:
    def __init__(self, addr, server_ip, skip=0):
        """
        This method is used to initialize Brand Recognition local video inference client
        ...
        self.csv_str = 'Frame #,Brand Recognition,Matched Files\n'
    ...
    def __str__(self):
        ...
        print("""
        ==========================================================
        | Brand Recognition Browser Based Local Inference Client |
        ==========================================================
        """)
    ...
    def __call__(self):
        ...
        while self.ret:
            ...
            if self.skip_count < self.skip:
                ...
                self.csv_str += f'{self.count},{self.res[0][0]},{self.res[1][0]}\n'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Brand Recognition Browser Based Local Video Inference Client.')

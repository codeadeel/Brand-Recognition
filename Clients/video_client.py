...
"""
BRAND RECOGNITION LOCAL INFERENCE CLIENT
========================================
...
class Video:
    ...
    def __call__(self, skip = 0):
        ...
        csv_str = 'Frame #,Brand Recognition,Matched Files\n'
        while ret:
            ...
            if skip_count < skip:
                ...
                csv_str += f'{count},{res[0][0]},{res[1][0]}\n'
            ...
            ocv.imshow('Brand Recognition : Local Video', cv_dat)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Brand Recognition Local Video Inference Client.')
